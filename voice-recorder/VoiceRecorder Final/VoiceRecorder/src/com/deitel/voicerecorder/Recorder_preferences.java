...
public class Recorder_preferences extends PreferenceActivity {
    private static final String RECORD_TYPE = "pref_key_record_type";
    private static final String RECORD_SPEED = "pref_key_record_speed"; 
    ...
    public static String getRecordSpeed(Context context) {
    	SharedPreferences settings = PreferenceManager.getDefaultSharedPreferences(context);
    	return settings.getString(RECORD_SPEED, context.getString(R.string.prefDefault_recordSpeed)); 
    }
